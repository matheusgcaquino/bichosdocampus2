...
@stop
  ...
  <div class="col-sm-12" style="background-image: url(imagens/home1.jpg); height: 400px; background-position: center; background-size: cover;"></div>
    ...
    <div class="col-sm-12">
      <div class="col-sm-4">
        ...
        <h4>Existem cerca de <b>400 gatos</b> vivendo na UFS.</h4>
          <a href="#adotar" class="btn btn-block btn bg-purple btn-lg" style="color: white;">Como adotar?</a>
      </div>
      <div class="col-sm-4">
        <h3><b>DOE</b></h3>
        <i class="fa fa-heart-o" style="font-size: 25px;"></i>
        <h4>São gastos cerca de <b>20KGs</b> de ração diariamente.</h4>
          <a href="#doacao" class="btn btn-block btn bg-olive btn-lg" style="color: white;">Como doar?</a>
      </div>
      <div class="col-sm-4">
...
<div class="col-sm-12" style="background-image: url(imagens/home2.jpg); height: 400px; background-position: center; background-size: cover;"></div>

  <div id="adotar" class="col-md-12" style="background: linear-gradient(to right, #ed213a, #93291e); padding: 5%; text-align: center; color: white;">
    ...
    <div class="col-sm-12" style="background-image: url(imagens/home3.jpg); height: 400px; background-position: center; background-size: cover;"></div>
  
    <div id="doacao" class="col-md-12" style="background: linear-gradient(to right, #ed213a, #93291e); padding: 5%; text-align: center; color: white;">
      <h2><b>Doações</b></h2>
...
<div class="col-sm-12" style="background-image: url(imagens/home5.jpg); height: 400px; background-position: center; background-size: cover;"></div>

<div id="sobre" class="box-footer" style="background: linear-gradient(to right, #ed213a, #93291e); margin-top: 5%;">
